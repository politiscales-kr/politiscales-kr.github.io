...
var questions = [
  ...
  {
    question:
      "어떤 두 나라가 비슷한 경제 및 사회 시스템, 그리고 환경 규제를 가지고 있다면, 두 나라 사이의 자유 시장은 부정적 영향을 주고받지 않을 것입니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question:
      "교외 생태계를 보전이 일자리 창출보다 더 중요합니다. <i>(그린벨트 보전을 비롯한 교외 생태계 보전이 일자리 창출보다 더 중요합니다.)</i>",
    answer: 0,
    valuesYes: [
      {
        axis: "e0",
  ...
  {
    question:
      "인간의 삶의 질을 높이기 위해, 생태계를 지속해서 변화시키는 것은 정당합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "e1",
