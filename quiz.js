...
var questions = [
  ...
  {
    question: "“태어나는 것이 아닌, 되는 것이 하나 있습니다. 바로 여성입니다.” <i>(남성/여성은 생물학적으로 타고나는 것이 아니라, 사회가 만드는 것입니다.)</i>",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "이성애/동성애/양성애와 같은 성적 지향은 생물학적으로 타고나는 것이 아닌 사회가 만드는 것입니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question:
      "인종 간의 사회적 차이는 생물학으로 설명될 수 없습니다. <i>(인종 간의 서로 다른 지능과 같은 차이점들은 타고나는 것이 아닌 성장 환경 등의 차이입니다.)</i>",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question:
      "국가를 등지게 되더라도, 이상을 위해 일어나 국가와 싸울 수 있어야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question:
      "어떤 두 나라가 서로 비슷한 경제 및 사회 시스템, 그리고 환경 규제를 가지고 있다면, 두 나라 사이의 자유시장은 두 나라 모두에 유익할 것입니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question:
      "스포츠 경기 중에도 다른 국가/민족을 배척하거나 우리 국가/민족의 우월함을 드러나는 태도는 금지되어야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question:
      "“전 우리나라의 국민들과 똑같이 다른 나라의 국민들에 대해서도 걱정하고 있습니다”.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question:
      "우리나라에 사는 외국인들은, 우리나라의 국민들과 동등하게 정치적으로 행동할 수 있어야 합니다. <i>(우리나라에 사는 외국인들도 내국인과 같이 시위, 노조, 단체 등을 자유롭게 결성할 수 있어야 합니다.)</i>",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question: "전기나 도로와 같은 분야는 언제나 국가에 의해 운영되어야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "p0",
  ...
  {
    question: "건설업과 같은 일부 산업 분야는 민간이 운영해도 좋습니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "p1",
  ...
  {
    question: "은행은 기업과 같은 민간에 의해 운영되어야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "p1",
  ...
  {
    question:
      "일부 직종 및 고용 유형은 재정적으로 지원되어야 합니다. <i>(정부는 사회간접자본을 이루는 일부 직종과, 사회적 약자 특별 채용 등을 재정적으로 지원해야 합니다.)</i>",
    answer: 0,
    valuesYes: [
      {
        axis: "m0",
  ...
  {
    question: "시장경제는 규제 없이 자유로울 때 가장 좋습니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "m1",
  ...
  {
    question:
      "오늘날의 노동자들은 자신의 고용 조건을 결정할 권한이 있습니다. <i>(노동자들은 다른 선택권이 없기 때문에 고용주가 제시한 조건을 받아들인 것이 아닙니다.)</i>",
    answer: 0,
    valuesYes: [
      {
        axis: "m1",
  ...
  {
    question:
      "환경 규제가 국가의 권위로 만들어져서는 안 됩니다. 환경 규제는 대량 소비<i>Mass consumption</i>와 같은 경제 흐름의 결과로 만들어져야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "m1",
  ...
  {
    question: "기술은 사회를 너무 빠르게 변화시키지 않도록 조심스럽게 적용되어야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "s1",
  ...
  {
    question:
      "학교는 주로 우리의 가치, 전통, 그리고 원리 원칙들을 가르쳐야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "s1",
  ...
  {
    question:
      "우리는 자연을 지키기 위해 곤충 요리나 배양육, 채식과 같은 새로운 식문화를 받아들여야만 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "e0",
  ...
  {
    question:
      "그린벨트 보전을 비롯한 교외 생태계 보전이 일자리 창출보다 더 중요합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "e0",
  ...
  {
    question:
      "개인정보는 철저히 보호되어야 합니다. 범죄와 관련이 있다고 해도 수사당국은 여러 데이터베이스를 비교해 개인을 추적해서는 안 됩니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "j0",
  ...
  {
    question: "처벌받을 수 있다는 공포가 범죄를 막을 수 있기 때문에, 무거운 처벌은 효율적입니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "j1",
  ...
  {
    question: "운동가<i>Activist</i>들은 법을 지키며 활동해야 합니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "개인에 대한 폭력은 결코, 언제나 생산적이지 않습니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question:
      "우리의 생각을 적용하기 위해서는 반대측과 타협할 필요가 있습니다.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
